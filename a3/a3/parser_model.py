...
class ParserModel(nn.Module):
    ...
    def forward(self, t):
        ...
        embeddings_forward = self.embedding_lookup(t)
        relu_layer = nn.ReLU()
        hidden_layer = relu_layer(self.embed_to_hidden(embeddings_forward))
        hidden_layer_with_dropout = self.dropout_layer(hidden_layer)
        logits = self.hidden_to_logits(hidden_layer_with_dropout)
